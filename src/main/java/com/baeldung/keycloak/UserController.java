...
import com.baeldung.keycloak.entity.User;
import com.baeldung.keycloak.entity.UserDTO;
...
public class UserController {
    ...
    private String authServerUrl = "https://auth.localtest.me/auth";
    private String realm = "my-example";
    private String clientId = "my-app";
    private String role = "student";
    //Get client secret from the Keycloak admin console (in the credential tab)
    private String clientSecret = "7a9cb076-e6c2-41e1-bc63-72e94fbbb251";
            ...
            @RequestBody User user ) throws Exception
    {
        ...
        final String baseUrl = "https://auth.localtest.me/auth/admin/realms/my-example/users";
